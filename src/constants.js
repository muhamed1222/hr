...
const LIMITS = {
  ...
  LOGIN_BLOCK_DURATION: 15 * 60, // 15 минут в секундах
  IP_BLOCK_DURATION: 24 * 60 * 60, // 24 часа в секундах
  // Новые лимиты для безопасности
  MAX_COUNTRIES_PER_HOUR: 3,
  MAX_IPS_PER_HOUR: 5,
  MAX_UNUSUAL_TIME_ACTIONS: 10,
  MAX_PAYLOAD_SIZE: 10 * 1024 * 1024, // 10MB
  MAX_REDIS_RECONNECT_ATTEMPTS: 5,
  REDIS_RECONNECT_DELAY: 5000, // 5 секунд
};
